...
fr: {
    ...
    headline: "Livin' par Gideon <span class='hash-tag'>#Au-delàSuperApp</span>",
...
es: {
    ...
    sukha_desc2: "Con Livin' Banca Móvil, siempre tienes elcontrol de tus finanzas. ¡Descarga la aplicación hoy y experimenta el futuro de la banca!",
    sukha_features: [
...
zh: {
    ...
    security_desc: "您的安全是我们的首要任务。我们采用先进的加密    和数据安全措施来保护您的信息。",
    ...
    const sukhaHeadline = document.querySelector('.sukha-content h2');      
        ...
        if (sukhaDesc1) sukhaDesc1.textContent = t.sukha_desc1;            const sukhaDesc2 = document.querySelector('.sukha-content p:nth-of-type(2)');
